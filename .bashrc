...
export PATH=/usr/bin:/bin:/usr/sbin:/sbin:/usr/local/bin:/usr/X11/bin:$JAVA_HOME/bin:$JYTHON_HOME/:$JYTHONPATH:/usr/local/opt/coreutils/libexec/gnubin:$HOME/.rvm/bin:$HOME/.gem/ruby/2.7.0/bin:/Users/jakejing/.rvm/gems/ruby-2.7.0:/Users/jakejing/.rvm/rubies/ruby-2.7.0/lib/ruby/gems/2.7.0
